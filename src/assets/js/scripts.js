"use strict";
const env = {
  server: "https://syselang.000webhostapp.com/api",
  version: "0.1.0",
  footerLeft: `Copyright © 2022 <div class="bullet"></div>Make by <a href="#">Elang Team</a>`,
};
...
$(document).ready(function () {
  ...
  $("#subject").val(sessionStorage.videoCategory);
});

$(".main-footer .footer-left").html(env.footerLeft);
$(".main-footer .footer-right").text(env.version);
$(".simple-footer").html(env.footerLeft + " " + env.version);
// Basic confirm box
